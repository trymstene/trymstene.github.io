...
const SVG = {
  ...
  // SOLID + 10 units, sized to fully cover a foot top-to-bottom incl its black
  // outline (~99px wide, y452-497) so nothing peeks — a chunky starter we can
  // refine. Red high-top, white sole, a lace flash.
