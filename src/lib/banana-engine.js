...
const SVG = {
  ...
  // SOLID (no transparent holes) and 9 units wide so it FULLY covers a foot
  // incl its black outline (measured full extent ~99px) — nothing peeks. Red
  // high-top, white sole, a lace flash.
  sneakers: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 40" width="90" height="40" shape-rendering="crispEdges"><rect x="0" y="0" width="90" height="10" fill="#111111"/><rect x="0" y="10" width="10" height="10" fill="#111111"/><rect x="10" y="10" width="70" height="10" fill="#e22020"/><rect x="80" y="10" width="10" height="10" fill="#111111"/><rect x="0" y="20" width="10" height="10" fill="#111111"/><rect x="10" y="20" width="30" height="10" fill="#e22020"/><rect x="40" y="20" width="10" height="10" fill="#ffffff"/><rect x="50" y="20" width="30" height="10" fill="#e22020"/><rect x="80" y="20" width="10" height="10" fill="#111111"/><rect x="0" y="30" width="10" height="10" fill="#111111"/><rect x="10" y="30" width="70" height="10" fill="#ffffff"/><rect x="80" y="30" width="10" height="10" fill="#111111"/></svg>',
