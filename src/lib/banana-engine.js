...
const SVG = {
  ...
  // sneakers — two shoes at the outer feet, white soles, a lace flash
  sneakers: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 40" width="160" height="40" shape-rendering="crispEdges"><rect x="10" y="0" width="30" height="10" fill="#111111"/><rect x="0" y="10" width="10" height="10" fill="#111111"/><rect x="10" y="10" width="30" height="10" fill="#e22020"/><rect x="40" y="10" width="10" height="10" fill="#111111"/><rect x="0" y="20" width="10" height="10" fill="#111111"/><rect x="10" y="20" width="10" height="10" fill="#e22020"/><rect x="20" y="20" width="10" height="10" fill="#ffffff"/><rect x="30" y="20" width="10" height="10" fill="#e22020"/><rect x="40" y="20" width="10" height="10" fill="#111111"/><rect x="0" y="30" width="10" height="10" fill="#111111"/><rect x="10" y="30" width="30" height="10" fill="#ffffff"/><rect x="40" y="30" width="10" height="10" fill="#111111"/><rect x="120" y="0" width="30" height="10" fill="#111111"/><rect x="110" y="10" width="10" height="10" fill="#111111"/><rect x="120" y="10" width="30" height="10" fill="#e22020"/><rect x="150" y="10" width="10" height="10" fill="#111111"/><rect x="110" y="20" width="10" height="10" fill="#111111"/><rect x="120" y="20" width="10" height="10" fill="#e22020"/><rect x="130" y="20" width="10" height="10" fill="#ffffff"/><rect x="140" y="20" width="10" height="10" fill="#e22020"/><rect x="150" y="20" width="10" height="10" fill="#111111"/><rect x="110" y="30" width="10" height="10" fill="#111111"/><rect x="120" y="30" width="30" height="10" fill="#ffffff"/><rect x="150" y="30" width="10" height="10" fill="#111111"/></svg>',
...
const SH_DY = -0.5;
// FEET anchor — measured from the sprite (tools/find, y>=452 band): the feet are
// STATIC across all 8 frames (cx≈234, band y 455→483), so footwear needs ONE
// anchor for the whole dance. Shoes hang from the feet BOTTOM so they sit flat.
const FEET_CX = 234, FEET_BOTTOM = 483;
