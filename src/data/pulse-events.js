...
export const EV_EXPLAIN = {
  ...
  post_send:'a letter was written back (at = post). ⭐ THE ONE NUMBER THAT SAYS WHETHER ANY OF THIS WORKS: a rail nobody answers on is a broadcast, not post. send ÷ read is the reply rate.',
