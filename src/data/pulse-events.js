...
export const EV_LABEL = {
  ...
  town_shift:'stood behind the Coffee Cup’s counter ☕',
...
export const EV_EXPLAIN = {
  ...
  town_duty:'the duties chip said something new today (at = the workplace; kind = duty | wage | payslip): once per line per day, so duty ÷ wage is how many who saw the day’s ask turned up, and payslip is a cheque announced in the square',
  ...
  town_chore:'a step of the shop’s restock chore (at, step = lift | stock). The chore pays nothing in coins: what it buys is the shelf. lift ÷ stock is how many crates get picked up and put down again',
