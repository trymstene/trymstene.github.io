# The sticker packs — the product photos' stamp

Trym received a printed sticker pack (pack #4, Party) and photographed it: the sheet in its
clear sleeve on a wooden table, the sheet out of the sleeve, and the sheet with a coin beside it
for size. These photos are shown on EVERY pack's page in the shop, because they show the real
...
- `alt` — the alt text of the photos: what is in the picture (a printed A5 sticker sheet of
  pixel bananas on a wooden table), plainly, for someone who cannot see it.

The voice guide holds. Curly apostrophes. No emoji. No number that is a rate or a time.
