...
Five residents can hire you: Pip at the general store, Spinner at the arcade, Bean at the Coffee
Cup, and since 22 Sep 2026 Stamp at the post office and Fig Jr. at the lemonade stand. You ask the way you ask them anything else — you walk up, you tap, and the question is on
their card beside the two they already answer. `work.ask` is that question, and it is in the
PLAYER'S voice.

`work.at` is the five workplaces' names as they fit INSIDE a sentence — they are dropped into
