...
const RANGE = {
  ...
  events: [
    ...
    { name: 'town_open', v: 11, u: 7 }, { name: 'town_fix', v: 38, u: 6 }, { name: 'town_buy', v: 3, u: 3 }, { name: 'town_curse', v: 4, u: 4 }, { name: 'town_dark', v: 5, u: 3 }, { name: 'town_multiplayer', v: 4, u: 3 }, { name: 'town_ghost', v: 2, u: 2 }, { name: 'town_object', v: 3, u: 2 }, { name: 'town_merchant', v: 1, u: 1 },
...
out.world = {
  ...
  town: ['Banana Town', 'walked into Banana Town', 'put something right in the town', 'bought a piece for home in the town', 'was in the town on a Curse Night', 'watched the ghosts cost the town', 'saw another banana in the town'].map((t) => [t, has(wd, t)]),
