...
export const KEYS = {
  ...
  'tw-job-v1': { travels: 'no', why: 'a MIRROR of the job you hold, so a boss’s card can answer in the same beat as the tap — world-dialogue types a string, never a promise. It decides which approved line is said and nothing else; worker-pass is the authority on the job and on every coin. It is filled from /job/view and, since 22 Sep 2026, from the job every push ack carries (banana-pass.js jobHint: a second phone learns its job, every phone learns of a sack); was + wasT remember a job just left, so the payslip it is still owed is asked for' },
  'tw-arcade-v1': { travels: 'no', why: 'which pieces of arcade litter you swept and which cabinet you woke TODAY (docs/town-jobs-plan.md §12) — the week’s counts live on the pass worker; this only stops the same piece being drawn twice on one device before midnight' },
  'tw-sort-v1': { travels: 'no', why: 'whether this device has played a round of sorting at the post office: the one-time notice under the pigeonholes shows through the first round only (Trym, 22 Sep) — nothing here is worth a byte on the pass' },
  'tw-calls-v1': { travels: 'no', why: 'h = the on-call workplace you were hired at today, whose calls are all in at once (24 Sep 2026, the job QA); and when this device’s day of CALLS began (the staff card plan, slice 0b): the arcade’s and the store’s calls arrive a few minutes after the first visit of the day and stay open until midnight, so the moment has to be remembered across a reload. Nothing of value: the calls are seeded per person (src/lib/work-calls.js) and the work they ask for counts on the pass worker. A walk may pin the day’s kinds under ?towntest (qa)' },
  'tw-serve-v1': { travels: 'no', why: 'how many customers you served at the store’s till TODAY (the job ladder’s slice 2, 23 Sep 2026): the day’s customer call is answered when it reaches two. Nothing of value: each serve counts on the pass worker’s week, and forging this only ends the day’s customers early' },
  'tw-deliver-v1': { travels: 'no', why: 'today’s parcel from the store (the ladder’s slice 3, 23 Sep 2026): picked up, being carried, or delivered, and whose door it is for. Nothing of value: the delivery’s XP is the pass worker’s, capped by the day; forging this only answers or reopens the day’s parcel call' },
  'tw-ghost-v1': { travels: 'no', why: 'the ghosts the arcade’s night manager has caught today (rank 5, 24 Sep 2026): each ghost counts as a repair once a day. Nothing of value: the XP is the pass worker’s, capped by the day' },
  'hs-seedhint-v1': { travels: 'no', why: 'which lines of the homestead\'s seed lesson this device has heard (arrive, soil, dug, done) and whether a first seed was planted (24 Sep 2026): each is said once, ever. Nothing of value' },
  'tw-sotw-v1': { travels: 'no', why: 'the week this device heard its boss say "staff of the week" (24 Sep 2026): the crown is told once, the next crown is a new week. The crown itself is the server\'s (j.sotw). Nothing of value' },
  'tw-told-v1': { travels: 'no', why: 'which of the arcade\'s "counts as a repair" lines (and the keyholder\'s tidy) were said today (24 Sep 2026, the job QA): once a day, not once a page load. Nothing of value' },
  'tw-once-v1': { travels: 'no', why: 'the one-time lines this device has heard (24 Sep 2026, the job QA): a counter\'s opening line at the first shift there, the post office\'s at the first round, the store\'s first customer\'s pointer and lesson. Nothing of value' },
  'tw-round-v1': { travels: 'no', why: 'today’s satchel from the post office (rank 5, 24 Sep 2026): its three letters, which are delivered. Nothing of value: each letter’s XP is the pass worker’s, capped by the day' },
  'tw-bus-v1': { travels: 'no', why: 'today’s mail bag from the bus stop (rank 6, 24 Sep 2026): waiting, carried or brought in, and whether its line was said. Nothing of value: the bag’s XP is the pass worker’s, capped by the day' },
  'tw-rush-v1': { travels: 'no', why: 'the day the café’s rush last came on this device (the ladder’s slice 3, 23 Sep 2026): one rush a day for a barista of the second rank. Nothing of value: the rush’s bonus is work XP the pass worker caps by the day, and forging this only brings a rush back or keeps it away' },
  'tw-streak-v1': { travels: 'no', why: 'perfect arcade repairs in a row on this device (the ladder’s slice 3, 23 Sep 2026): the count Spinner’s cabinet tech is told after a perfect one. Nothing of value: a number said in a toast; every repair counts on the pass worker’s week by its own grade' },
  ...
  'hq-floor-v1': { travels: 'no', why: 'which floor of Banana HQ was last open — a view preference on this desk' },
