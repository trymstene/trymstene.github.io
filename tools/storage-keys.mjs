...
export const KEYS = {
  ...
  'hs-seedhint-v1': { travels: 'no', why: 'the day the homestead last said "you have seeds from the park" on arrival (24 Sep 2026): once a day, not every visit. Nothing of value' },
