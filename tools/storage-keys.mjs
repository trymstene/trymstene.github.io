...
export const KEYS = {
  ...
  'tw-memento-v1': { travels: 'no', why: 'which workplaces’ top-rank mementos this device has put in the homestead shed (the ladder’s top, 24 Sep 2026): each boss’s gift once. Nothing of value beyond the piece itself, which is the shed’s; forging this only withholds or repeats a gift of a decor piece' },
