...
export const KEYS = {
  ...
  'tw-once-v1': { travels: 'no', why: 'the one-time lines this device has heard (24 Sep 2026, the job QA): a counter\'s opening line at the first shift there, the post office\'s at the first round. Nothing of value' },
