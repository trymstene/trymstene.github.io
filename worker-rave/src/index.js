...
const HAT_IDS = ['none', 'party', 'crown', 'tophat', 'cowboy', 'viking', 'sombrero', 'halo', 'beanieprop', 'backwardscap'];
const SHADE_IDS = ['none', 'shades', 'hearts', 'visor', 'threed', 'dwi', 'potter', 'nerd'];
const EXTRA_IDS = ['mustache', 'fatstache', 'bowtie', 'necktie', 'goldchain', 'scarf', 'sneakers', 'sneakersblue', 'sneakersgold', 'skates', 'clownshoes', 'cowboyboots', 'discoboots', 'boombox', 'mug', 'glowstick', 'goldbanana'];
